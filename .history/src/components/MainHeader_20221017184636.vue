        ...
        <div class="wujiu-header-banner">
            <a-row class="wujiu-header-bar">
                <a-col :xs="8" :sm="8" :md="8" :lg="6" :xl="4">
                    <router-link to="/" @click="reload()">无咎易修</router-link>
                </a-col>
                <a-col :xs="8" :sm="8" :md="8" :lg="12" :xl="16">&nbsp;</a-col>
                <a-col :xs="8" :sm="8" :md="8" :lg="6" :xl="4">
                    <ul>
                        <li>
                            <a-dropdown v-show="userData == true">
                            ...
                            <a-dropdown v-show="userData == false">
                                <a class="ant-dropdown-link" @click.prevent>
                                    {{ userName }}
                                    <DownOutlined />
                                </a>
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            active: '',
            userData: this.$store.state.userData == null,
            userName: this.$store.state.userData != null ? this.$store.state.userData.data.name : null
        }
    },
    setup() {
        return {}
