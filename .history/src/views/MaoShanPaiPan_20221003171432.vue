                        ...
                        <a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12" :xxxl="8" class="home-col-form">
                            ...
                            <div class="home-form-box">
                                        ...
                                        <a-col span="8">
                                            <a-form-item label="分" v-bind="validateInfos.minute">
                                                <a-select v-model:value="modelRef.minute" placeholder="分">
                                                    <a-select-option :value="item" v-for="item in minute" :key="item">
                                                        {{ item }}</a-select-option>
                                                </a-select>
                                            </a-form-item>
                                        </a-col>
                                        <a-col span="8">
                                            <a-form-item label="秒" v-bind="validateInfos.second">
                                                <a-select v-model:value="modelRef.second" placeholder="秒">
                                                    <a-select-option :value="item" v-for="item in second" :key="item">
                                                        {{ item }}</a-select-option>
                                                </a-select>
                                            </a-form-item>
                                        </a-col>
                                ...
                                <a-form-item :wrapper-col="{ span: 24, offset: 0 }">
                                    <a-button class="create-paipan" type="" @click.prevent="onSubmit(1)">阳历排盘</a-button>
                            ...
                            <div class="home-xinxi" v-if="paiPanDateRef.yangli != ''">
                                ...
                                <span>旬首：{{ paiPanDateRef.xunshou }}&nbsp;&nbsp;&nbsp;日空亡：{{ paiPanDateRef.rikongwang }}
                                    &lt;转盘> </span><br>
...
export default defineComponent({
    name: "MaoShanPaiPan",
    // metaInfo: {
    //     title: '茅山奇门遁甲排盘', // set a title
    //     meta: [{                 // set meta
    //         name: '无咎易修，刘文元茅山奇门排盘，茅山奇门排盘',
    //         content: '这是一个可以免费茅山奇门排盘，玄空风水，紫白飞星排盘的网站'
    //     }]
    // },
    setup() {
        // 获取当前时间
