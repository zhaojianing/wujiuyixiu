                                            ...
                                            <a-col span="8">
                                                <a-form-item label="几运">
                                                    <a-select v-model:value="xuankongRef.jiuyun" placeholder="几运">
                                                        <a-select-option :value="item" v-for="item in xuankongjiuyun"
                                                            :key="item">{{
                                                            item
                                                            }}
                                                        </a-select-option>
                                            ...
                                            <a-col span="8">
                                                <a-form-item label="坐向">
                                                    <a-select v-model:value="xuankongRef.zuoshan" placeholder="坐向">
                                                        <a-select-option :value="item" v-for="item in xuankongzuoshan"
                                                            :key="item">
                                                            {{ item }}</a-select-option>
                                                    </a-select>
                                                </a-form-item>
...
export default defineComponent({
    name: "XuanKongPaiPan",
    // metaInfo: {
    //     title: '玄空风水排盘', // set a title
    //     meta: [{                 // set meta
    //         name: '无咎易修，紫白飞星，玄空风水排盘',
    //         content: '这是一个可以免费玄空风水，紫白飞星排盘的网站'
    //     }]
    // },
    setup() {
        // 获取当前时间
