        ...
        <a-row class="sign-row">
            ...
            <a-col :xs="24" :sm="16" :md="16" :lg="14" :xl="14">
                <div class="sign-container">
                    ...
                    <a-button type="primary" html-type="submit" v-on:click="login">{{ uText[0] + uText[1] }}</a-button>
                    <u @click="changeLogin">{{ uText[2] + uText[3] }}</u>
...
export default defineComponent({
    ...
    methods: {
        ...
        changeLogin() {
            this.uText = this.uText.slice(2,3) + this.uText.slice(0,1)
