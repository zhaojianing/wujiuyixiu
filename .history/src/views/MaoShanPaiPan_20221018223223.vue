                            ...
                            <a-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12" :xxxl="8" class="home-col-form">
                                ...
                                <div class="create-paipan-save" v-if="isSaveFlag">
                                    <a-form :model="paipanFormState" v-bind="layout" name="nest-messages">
                                        <a-form-item :name="['user', 'email']" label="时间">
                                            <span>{{modelRef.year}}</span>
                                            <span>{{modelRef.month}}</span>
                                            <span>{{modelRef.day}}</span>
                                            <span>{{modelRef.hour}}</span>
                                            <span>{{modelRef.minute}}</span>
                                            <span>{{modelRef.second}}</span>
                                            <!-- <a-input class="create-paipan-save-disable-time" v-model:value="modelRef.year" disabled/>
                                            <a-input class="create-paipan-save-disable-time" v-model:value="modelRef.month" disabled/>
                                            <a-input class="create-paipan-save-disable-time" v-model:value="modelRef.day" disabled/>
                                            <a-input class="create-paipan-save-disable-time" v-model:value="modelRef.hour" disabled/>
                                            <a-input class="create-paipan-save-disable-time" v-model:value="modelRef.minute" disabled/>
                                            <a-input class="create-paipan-save-disable-time" v-model:value="modelRef.second" disabled/> -->
                                        </a-form-item>
            ...
            .home-row-form
                .home-col-form
                    ...
                    .create-paipan-save
                        ...
                        padding 5px
                        margin-top 10px
                        .create-paipan-save-disable-time
                            width 16.6%
                    .home-xinxi
                        background-color #f1f1f1
                        border-radius 6px
