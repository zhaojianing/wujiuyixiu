                                ...
                                <div class="create-paipan-save" v-if="isSaveFlag">
                                    <a-form :model="paipanFormState" v-bind="layout" name="nest-messages">
                                        <a-form-item :name="['user', 'email']" label="时间">
                                            <a-input v-model:value="modelRef.year" disabled/>
                                            <a-input v-model:value="modelRef.month" disabled/>
                                            <a-input v-model:value="modelRef.day" disabled/>
                                            <a-input v-model:value="modelRef.hour" disabled/>
                                            <a-input v-model:value="modelRef.minute" disabled/>
                                            <a-input v-model:value="modelRef.second" disabled/>
                                        </a-form-item>
