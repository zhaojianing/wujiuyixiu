    ...
    <div class="photography">
        <a-row class="photography-row">
            ...
            <a-col :xs="20" :sm="16" :md="16" :lg="14" :xl="14">
                ...
                <strong v-show="loadText == ''" @click="loadMoreImage(startNum, endNum)">{{ loadText }}</strong>
            </a-col>
            <a-col :xs="2" :sm="4" :md="4" :lg="5" :xl="5"></a-col>
        </a-row>
    </div>
...
export default defineComponent({
    ...
    mounted() {
        ...
        this.loadMoreImage(this.startNum, this.endNum)
    },
    methods: {
        loadMoreImage(start: number, end: number) {
