                                ...
                                <div class="create-paipan-save" v-if="isSaveFlag">
                                    <a-form :model="paipanFormState" v-bind="layout" name="nest-messages">
                                        <a-form-item :name="['user', 'email']" label="时间">
                                            <a-input v-model:value="paipanFormState.user.email" disabled/>
                                        </a-form-item>
...
export default defineComponent({
    ...
    setup() {
        ...
        const paipanFormState = reactive({
            user: {
                name: '',
                email: validateInfos.year + '-' + validateInfos.month + '-' + validateInfos.day + '-' + validateInfos.hour + '-' + validateInfos.minute + '-' + validateInfos.second,
                introduction: '',
            },
        });
