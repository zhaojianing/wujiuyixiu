        ...
        <a-row class="sign-row">
            ...
            <a-col :xs="24" :sm="16" :md="16" :lg="14" :xl="14">
                <div class="sign-container">
                    ...
                    <a-form-item class="error-infos" :wrapper-col="{ span: 8 }" v-bind="errorInfos">
...
export default defineComponent({
    ...
    methods: {
        login() {
            ...
            if (this.isCreate) {
                // 注册逻辑
                const { resetFields, validate, validateInfos, mergeValidateInfo } = useForm(this.formState, this.rules);
                const errorInfos = computed(() => {
                    return mergeValidateInfo([validateInfos]);
                });
                console.log(errorInfos)
                // this.errorInfos = errorInfos.toString()
                validate()
                    .then(() => {
